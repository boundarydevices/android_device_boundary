...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/galilei/logo_img_files

ifeq ($(BOARD_BUILD_SYSTEM_ROOT_IMAGE), true)
TARGET_RECOVERY_FSTAB := device/amlogic/galilei/recovery/recovery_system.fstab
else
TARGET_RECOVERY_FSTAB := device/amlogic/galilei/recovery/recovery.fstab
endif
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/amlogic/galilei/bluetooth
...
DEVICE_MANIFEST_FILE := device/amlogic/galilei/manifest.xml
