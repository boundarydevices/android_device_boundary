...
PRODUCT_COPY_FILES += \
    ...
    device/boundary/common/apns-full-conf.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/apns-conf.xml \
...
# NFC config files
PRODUCT_COPY_FILES += \
    device/boundary/nitrogen8mm_tab/nfc/libnfc-nci.conf:system/etc/libnfc-nci.conf \
    device/boundary/nitrogen8mm_tab/nfc/libnfc-nxp.conf:vendor/etc/libnfc-nxp.conf
