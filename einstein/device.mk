...
PRODUCT_COPY_FILES += \
    device/amlogic/einstein/files/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml \
    device/amlogic/einstein/files/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml \
...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/einstein/files/remote.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/remote.cfg \
    device/amlogic/einstein/files/remote.tab:$(TARGET_COPY_OUT_VENDOR)/etc/remote.tab \
...
PRODUCT_COPY_FILES += \
    device/amlogic/einstein/files/Generic.kl:/$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/Generic.kl
else
PRODUCT_COPY_FILES += \
...
# recovery
PRODUCT_COPY_FILES += \
    device/amlogic/einstein/recovery/init.recovery.amlogic.rc:root/init.recovery.amlogic.rc \
    device/amlogic/einstein/recovery/recovery.kl:recovery/root/etc/recovery.kl \
    device/amlogic/einstein/files/mesondisplay.cfg:recovery/root/etc/mesondisplay.cfg \
    device/amlogic/einstein/recovery/remotecfg:recovery/root/sbin/remotecfg \
    device/amlogic/einstein/files/remote.cfg:recovery/root/etc/remote.cfg \
    device/amlogic/einstein/files/remote.tab:recovery/root/etc/remote.tab \
    device/amlogic/einstein/recovery/sh:recovery/root/sbin/sh

# einstein config file
PRODUCT_COPY_FILES += \
    device/amlogic/einstein/files/tv/tvconfig.conf:$(TARGET_COPY_OUT_VENDOR)/etc/tvconfig.conf \
    device/amlogic/einstein/files/tv/tv_default.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/tv_default.cfg \
    device/amlogic/einstein/files/tv/tv_default.xml:$(TARGET_COPY_OUT_VENDOR)/etc/tv_default.xml \
    device/amlogic/einstein/files/tv/tv_setting_config.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/tv_setting_config.cfg \
    device/amlogic/einstein/files/tv/pq.db:$(TARGET_COPY_OUT_VENDOR)/etc/pq.db \
    device/amlogic/einstein/files/tv/dec:$(TARGET_COPY_OUT_VENDOR)/bin/dec \
    device/amlogic/einstein/files/tv/port_14.bin:$(TARGET_COPY_OUT_VENDOR)/etc/tvconfig/hdmi/port_14.bin \
    device/amlogic/einstein/files/tv/port_20.bin:$(TARGET_COPY_OUT_VENDOR)/etc/tvconfig/hdmi/port_20.bin \
