...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/franklin/logo_img_files

ifeq ($(BOARD_BUILD_SYSTEM_ROOT_IMAGE), true)
TARGET_RECOVERY_FSTAB := device/amlogic/franklin/recovery/recovery_system.fstab
else
TARGET_RECOVERY_FSTAB := device/amlogic/franklin/recovery/recovery.fstab
endif
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/amlogic/franklin/bluetooth
