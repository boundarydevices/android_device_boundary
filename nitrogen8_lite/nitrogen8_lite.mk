...
# Overrides
PRODUCT_NAME := nitrogen8_lite
PRODUCT_DEVICE := nitrogen8_lite
PRODUCT_MODEL := NITROGEN8_LITE

PRODUCT_DEFAULT_DEV_CERTIFICATE := \
    device/boundary/nitrogen8_lite/security/testkey

PRODUCT_PROPERTY_OVERRIDES += ro.screenpinrequest.skip=true
...
# Audio card json
PRODUCT_COPY_FILES += \
    device/boundary/common/audio-json/wm8960_config.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/audio/wm8960_config.json \

ifeq ($(PRODUCT_IMX_TRUSTY),true)
PRODUCT_COPY_FILES += \
    device/boundary/nitrogen8_lite/security/rpmb_key_test.bin:rpmb_key_test.bin \
    device/boundary/nitrogen8_lite/security/testkey_public_rsa4096.bin:testkey_public_rsa4096.bin
endif
