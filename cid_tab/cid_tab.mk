...
PRODUCT_COPY_FILES += \
	...
	device/boundary/cid_tab/required_hardware.xml:vendor/etc/permissions/required_hardware.xml \
...
BOARD_CUSTOM_BT_CONFIG := device/boundary/cid_tab/libbt_vnd.conf
