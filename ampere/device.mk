...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/ampere/files/pq.db:$(TARGET_COPY_OUT_VENDOR)/etc/tvconfig/pq.db

ifeq ($(USE_XML_AUDIO_POLICY_CONF), 1)
PRODUCT_COPY_FILES += \
    device/amlogic/ampere/files/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
    device/amlogic/ampere/files/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml
else
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    device/amlogic/ampere/files/media_codecs_ext.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_ext.xml
endif
