...
# Support GPT
BOARD_BPT_INPUT_FILES += device/boundary/common/partition/device-partitions-16GB.bpt
...
TARGET_BOOTLOADER_BOARD_NAME := nitrogen8mp
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/$(PRODUCT_DEVICE)/dtbo-imx8mp.img
