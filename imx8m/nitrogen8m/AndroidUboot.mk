...
define build_imx_uboot
	...
	UBOOT_PATH=../../../$(UBOOT_OUT) UBOOT_DTB=imx8mq-nitrogen8m$$isSom.dtb SOC=iMX8MQ ./make_boundary.sh $$SZ; \
	cd -; \
	uuu=`echo $3 | cut -d' ' -f2`; \
	cp -v $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/u-boot-lpddr4-iMX8MQ-$$SZ.hdmibin $(PRODUCT_OUT)/boot/u-boot.$$uuu;
endef
